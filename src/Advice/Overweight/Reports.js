        ...
        <div className="container py-4" id="WhatIsBMI">
          ...
          <div className="row align-items-start my-2">
            <div className="col-md-8 col-sm-12 intro">
              ...
              2020, prevalence rate of obesity and central obesity are varies
              from 11.8% to 31.3% and 16.9%-36.3% respectively. <br /> In
              <span className="text-danger fw-bold"> India</span>, abdominal
              obesity is one of the major risk factors for cardiovascular
              disease (CVDs).
        ...
        <div className="container py-4" id="WhatIsBMI">
          ...
          <div className="row align-items-start my-2">
            <div className="col-md-8 col-sm-12 intro">
              ...
              third annual report of Poshan Abhiyan said that the nation needs
              to mobilize solid efforts to address the emerging and
              cross-cutting challenges of urbanization and Overweight-Obesity
              (O-O). <br />
              <br />
              Along with Poshan Abhiyan, the government of India under Food
              Safety and Standards Authority of India also launched ‘Eat Right’
              programme in the year 2017. The Eat Right India is aligned to the
              National Health Policy 2017 with its focus on preventive and
              promotive healthcare and flagship programmes like Ayushman Bharat,
              Poshan Abhiyaan, Anemia Mukt Bharat and Swacch Bharat Mission. The
              campaign focusses on making a social and behavioural change around
              food safety and nutrition at home, school, workplace and
              on-the-go. Another focus is on reduction of high fat, sugar and
              salt foods in the diet; and Food Fortification, focused on
              promoting five staple foods-wheat flour, rice, oil, milk and salt
              that are added with key vitamins and minerals to improve their
              nutritional content.
            </div>
            <img
